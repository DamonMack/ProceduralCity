...
void Object::MakeTexturedQuad(std::string fileName){
        ...
        m_geometry.AddVertex(1.0f,-1.0f, 0.0f, 0.0f, 0.0f);
        m_geometry.AddVertex( 1.0f,-1.0f, -2.0f, 1.0f, 0.0f);
    	m_geometry.AddVertex( 1.0f, 1.0f, -2.0f, 1.0f, 1.0f);
        m_geometry.AddVertex(1.0f, 1.0f, 0.0f, 0.0f, 1.0f);

        m_geometry.MakeTriangle(0 + 4, 1 + 4, 2 + 4);
        m_geometry.MakeTriangle(2 + 4, 3 + 4, 0 + 4);
...
void Object::MakeFloor(int xStart, int xEnd, int zStart, int zEnd, std::string fileName) {
    m_geometry.AddVertex(xStart, 0.0f, zStart, 0.0f, 0.0f);
    m_geometry.AddVertex(xEnd, 0.0f, zStart, 1.0f, 0.0f);
    m_geometry.AddVertex(xEnd, 0.0f, zEnd, 1.0f, 1.0f);
    m_geometry.AddVertex(xStart, 0.0f, zEnd, 0.0f, 1.0f);
